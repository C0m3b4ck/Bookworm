; Bookworm410.nsi
Outfile "Bookworm410_installer.exe"
...
Section "Install"
  SetOutPath "$INSTDIR"
  File "bookworm_gui_v410.exe"
  File "updater_v100.exe"
  File "themecreator_v100.exe"
  File "LICENSE.txt"
  
  CreateShortcut "$DESKTOP\Bookworm.lnk" "$INSTDIR\bookworm_gui_v410.exe"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\bookworm_gui_v410.exe"
