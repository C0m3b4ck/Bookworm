...
Section "Install"
  SetOutPath "$INSTDIR"
  File "booklist_gui_v300.exe"
  File "updater_v100.exe"
  File "themecreator_v100.exe"
  
  CreateShortcut "$DESKTOP\Bookworm.lnk" "$INSTDIR\booklist_gui_v300.exe"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\booklist_gui_v300.exe"
